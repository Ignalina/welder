...
mvn deploy:deploy-file -Durl=https://nexus.x14.se -Dfile=target/welder-spark-job-0.0.1-SNAPSHOT.jar -DgroupId=dk.ignalina.lab.spark232 -DartifactId=welder-spark-job -Dpackaging=jar -Dversion=0.0.1-SNAPSHOT -DrepositoryId=x14-repo
